...
//        ----------------------------------------------------------------------------------------------
        // test 1
//        Penguin mother, father;
//        mother = new Penguin(new Genome("TTAAGCCACTTTG"),5);
//        father = new Penguin(new Genome("GTAAGATACTATG"),5);
//        Penguin child = mother.mateWith(father);
//        write("Day 0:" +child.toString());

//        write("Day 1: Hunt " + child.hunt(45) +" Fishes");
//        child.eat();
//        write("Day 1:" +child.toString());

//        write("Day 2: Hunt " + child.hunt(60) +" Fishes");
//        child.eat();
//        write("Day 2:" +child.toString());
//
//        write("Day 3: Hunt " + child.hunt(15) +" Fishes");
//        child.eat();
//        write("Day 3:" +child.toString());

//        // test sleep():
//        write("Mother before sleep 0: "+ mother.toString() + "Age: "+mother.getAgeInDays());
//        write("Child before sleep 0:" +child.toString() +"Age: "+child.getAgeInDays());
//
//        for(int i =0; i<10; i++) {
//            mother.sleep();
//            if (!mother.sleep())
//                write("Mother is dead");
//            child.sleep();
//        }
//        write("Mother after sleep 2: "+ mother.toString() +"Age: "+mother.getAgeInDays());
//        write("Child after sleep 2:" +child.toString() + "Age: "+child.getAgeInDays());
//
//        PenguinColony pc = new PenguinColony();
//        write("Start size: " +pc.getPopulation().size());
//        Penguin a = pc.createPenguin(new Genome("GTAAGATACTATG"));
//        write(a.toString());
//        write("Then size: " + pc.getPopulation().size());
...
//        a.set(0,88);
//        write(""+a.get(0));
//        PenguinList pl1 = new PenguinList();
//        PenguinList pl2 = new PenguinList();
//        Penguin p1 = new Penguin(new Genome("GTAAGATACTATG"),15);
//        Penguin p2 = new Penguin(new Genome("GGAAGATACAATG"),6);
//        Penguin p3 = new Penguin(new Genome("TTAAGATCCTATG"),12);
//        Penguin p4 = new Penguin(new Genome("TTAAGGTCATATA"),4);
//        Penguin p5 = new Penguin(new Genome("TTCAGGTCATATT"),10);
//        pl1.add(p1);
//        pl1.add(p2);
//        pl1.add(p3);
//        pl1.add(p4);
...
//            System.out.println("Age: "+pl1.get(i).getAgeInDays()+" "+pl1.get(i).toString());
//        System.out.println("----------------------------------------------------------");
//        pl2 = pl1.sort();
//        for(int i=0;i<pl2.size();i++)
//            System.out.println("Age: "+pl2.get(i).getAgeInDays()+" "+pl2.get(i).toString());
// ---------------------------------------------------------------------------------------------------------
    }
